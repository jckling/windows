...
Personal list of applications and tools for Windows 10.
...
- [Sougou Input](https://shurufa.sogou.com)
...
- [FFXIV CN](https://ff.web.sdo.com/web8/index.html#/download)

### FFXIV Tools

- [ACT](https://www.ffcafe.cn/act)
- [Anamnesis](https://github.com/imchillin/Anamnesis)
- [FFXIVQuickLauncher](https://github.com/ottercorp/FFXIVQuickLauncher)
